    ...
    public void onClick(View v, int position) {
        switch (v.getId()){
            ...
            case R.id.talent_list_btn_row_item:
                ConstantUtils.LiveExam.previousQuestionID = dataList.get(position).getId();
                Navigation.findNavController(binding.examByTypeArkayvedRV).navigate(R.id.rankListFragment);
                break;
            case R.id.question_btn_row_item:
                ConstantUtils.LiveExam.previousQuestionID = dataList.get(position).getId();
                Navigation.findNavController(binding.examByTypeArkayvedRV).navigate(R.id.examQuestionFragment);
                break;
